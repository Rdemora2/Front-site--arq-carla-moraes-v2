...
export default function ProjectsPage() {
  ...
  return (
    <>
      ...
      <SiteHeader />
      <main id="conteudo">
        <section className="relative isolate flex min-h-[34rem] items-end overflow-hidden bg-forest-deep pb-16 pt-32 text-canvas sm:min-h-[39rem] sm:pb-20 lg:min-h-[42rem]">
          ...
          <div className="page-frame relative">
            ...
            <h1 className="text-balance mt-6 max-w-5xl font-editorial text-display-sm font-medium text-canvas lg:text-display">Projetos que transformam a forma de <em className="font-normal text-gold-soft">viver o espaço.</em></h1>
            <p className="mt-7 max-w-xl text-sm leading-7 text-canvas/75 sm:text-base sm:leading-8">Uma seleção de jardins residenciais e espaços corporativos criados com leitura técnica, sensibilidade e atenção ao tempo da natureza.</p>
          </div>
        </section>

        <section aria-labelledby="titulo-acervo" className="section-space bg-canvas">
          <div className="page-frame">
            <div className="reveal grid gap-8 border-b border-line pb-10 lg:grid-cols-12 lg:items-end">
              <div className="lg:col-span-8">
                <p className="eyebrow">Residencial · Corporativo</p>
                <h2 id="titulo-acervo" className="mt-5 font-editorial text-section-sm font-medium text-forest-deep sm:text-section">Paisagens com identidade própria.</h2>
              </div>
              <div className="flex gap-8 lg:col-span-4 lg:justify-end lg:pb-2">
                <p className="text-xs uppercase tracking-[0.15em] text-ink-muted"><span className="font-editorial text-2xl text-forest-deep">02</span><br />residenciais</p>
                <p className="text-xs uppercase tracking-[0.15em] text-ink-muted"><span className="font-editorial text-2xl text-forest-deep">02</span><br />corporativos</p>
              </div>
            </div>
        ...
        <section className="bg-canvas-soft py-16 sm:py-20">
          <div className="page-frame reveal flex flex-col gap-7 sm:flex-row sm:items-center sm:justify-between">
            <div>
              ...
              <h2 className="mt-3 font-editorial text-3xl font-medium text-forest-deep sm:text-4xl">Conte para a Carla o que você deseja transformar.</h2>
            </div>
            <Link href={contactLinks.whatsapp} target="_blank" rel="noopener noreferrer" className="group inline-flex min-h-14 shrink-0 items-center justify-center gap-3 rounded-full bg-forest px-7 text-[0.66rem] font-semibold uppercase tracking-[0.16em] text-canvas transition-colors hover:bg-forest-deep">
