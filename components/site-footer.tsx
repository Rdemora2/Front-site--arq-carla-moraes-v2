...
export function SiteFooter() {
  return (
    <footer className="safe-bottom bg-surface-contrast text-content-onContrast">
      ...
      <div className="page-frame grid gap-5 pb-24 pt-7 text-[0.6rem] uppercase tracking-[0.13em] text-content-onContrast/60 sm:grid-cols-2 lg:grid-cols-[1fr_auto_1fr] lg:items-center lg:!pr-44 xl:!pr-44">
